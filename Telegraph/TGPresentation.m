...
- (TGSearchBarPallete *)searchBarPallete
{
    ...
    if ([accentColor isEqual:self.pallete.searchBarPlainBackgroundColor]) {
        accentColor = self.pallete.accentContrastColor;
    }
    return [TGSearchBarPallete palleteWithDark:self.pallete.prefersDarkKeyboard backgroundColor:self.pallete.searchBarBackgroundColor highContrastBackgroundColor:self.pallete.searchBarMergedBackgroundColor textColor:self.pallete.searchBarTextColor placeholderColor:self.pallete.searchBarPlaceholderColor clearIcon:self.images.searchClearIcon barBackgroundColor:self.pallete.barBackgroundColor barSeparatorColor:self.pallete.barSeparatorColor plainBackgroundColor:self.pallete.searchBarPlainBackgroundColor accentColor:accentColor accentContrastColor:self.pallete.accentContrastColor menuBackgroundColor:self.pallete.menuBackgroundColor segmentedControlBackgroundImage:self.images.segmentedControlBackgroundImage segmentedControlSelectedImage:self.images.segmentedControlSelectedImage segmentedControlHighlightedImage:self.images.segmentedControlHighlightedImage segmentedControlDividerImage:self.images.segmentedControlDividerImage];
}

- (TGSearchBarPallete *)keyboardSearchBarPallete
{
    return [TGSearchBarPallete palleteWithDark:self.pallete.prefersDarkKeyboard backgroundColor:self.pallete.chatInputKeyboardSearchBarColor highContrastBackgroundColor:self.pallete.chatInputKeyboardSearchBarColor textColor:self.pallete.searchBarTextColor placeholderColor:self.pallete.searchBarPlaceholderColor clearIcon:self.images.searchClearIcon barBackgroundColor:self.pallete.barBackgroundColor barSeparatorColor:[UIColor clearColor] plainBackgroundColor:[UIColor clearColor] accentColor:self.pallete.accentColor accentContrastColor:self.pallete.accentContrastColor menuBackgroundColor:self.pallete.menuBackgroundColor segmentedControlBackgroundImage:self.images.segmentedControlBackgroundImage segmentedControlSelectedImage:self.images.segmentedControlSelectedImage segmentedControlHighlightedImage:self.images.segmentedControlHighlightedImage segmentedControlDividerImage:self.images.segmentedControlDividerImage];
}
...
- (TGConversationAssociatedInputPanelPallete *)associatedInputPanelPallete
{
    ...
    UIColor *secondaryTextColor = self.pallete.secondaryTextColor;
    UIColor *backgroundColor = self.pallete.backgroundColor;
    if ([accentColor isEqual:self.pallete.barBackgroundColor]) {
        backgroundColor = accentColor;
        accentColor = self.pallete.accentContrastColor;
        textColor = secondaryTextColor = self.pallete.navigationSubtitleColor;
    }
    return [TGConversationAssociatedInputPanelPallete palleteWithDark:self.pallete.isDark backgroundColor:backgroundColor separatorColor:self.pallete.separatorColor selectionColor:self.pallete.selectionColor barBackgroundColor:self.pallete.barBackgroundColor barSeparatorColor:self.pallete.barSeparatorColor textColor:textColor secondaryTextColor:secondaryTextColor accentColor:accentColor placeholderBackgroundColor:nil placeholderIconColor:nil avatarPlaceholder:[self.images avatarPlaceholderWithDiameter:32.0f] closeIcon:self.images.replyCloseIcon largeCloseIcon:self.images.pinCloseIcon];
